...
/*
@Database(entities = [JaapEntity::class, JaapHistoryEntity::class, GoalEntity::class], version = 4, exportSchema = true)
...
val MIGRATION_2_3 = object : Migration(2, 3) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        // Create goals table with status column
        db.execSQL(
            """
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS index_goals_jaapId ON goals(jaapId)")
    }
